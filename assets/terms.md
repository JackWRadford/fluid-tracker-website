...
We assume that you do not jailbreak or root your phone, which is the process of removing software restrictions and limitations imposed by the official operating system of your device. It could make your phone vulnerable to malware/viruses/malicious programs, compromise your phone’s security features and it could mean that the Fluidify app won’t work properly or at all.
...
Furthermore, while it is the app's goal to help users remain hydrated, Jack Radford takes no responsibilty to ensure that this is the case for users, and is not accountable for any direct or indirect lose of health, or other negative impact on users.
